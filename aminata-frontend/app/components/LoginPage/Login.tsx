...
const Login = () => {
  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row h-screen font-poppins text-xl p-12">
      <div className="bg-[#287100] sm:w-1/3 flex justify-center " >
        <div className="-ml-28  w-20 h-18 mt-28">
        <img src="/images/Logo.png" alt="Logo" />
        </div>
        <div>
        <p className="-ml-20 mt-72 text-5xl font-['Poppins'] font-semibold text-[#F59B22] mb-9">Welcome
       </p>
        ...
        <form className="flex flex-col items-center  sm:w-80 h-4">
          ...
          <div className="relative mb-4 sm:mb-6 w-/3">
            ...
            <input
              ...
              className="text-sm  text-black w-full solid border-custom-brown  h-10 border rounded px-4 py-2 mb-4"
            />
            </div>
            <button
              type="button"
